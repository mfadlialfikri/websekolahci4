...
class Staff_model extends Model
{
    ...
    protected $allowedFields      = ['id_staff', 'id_user', 'nama_kategori_staff', 'nama', 'alamat', 'telepon','website','email','jabatan','keahlian','gambar','status_staff','tempat_lahir','tanggal_lahir','tanggal'];
